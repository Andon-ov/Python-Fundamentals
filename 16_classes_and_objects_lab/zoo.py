...
# On the following n lines you will receive animal info in the format: "{species} {name}". Add the animal to the zoo
# to the corresponding list. The species could be "mammal", "fish", or "bird".
